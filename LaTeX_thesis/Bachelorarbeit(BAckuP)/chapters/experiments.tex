...
Tossing a ball is pretty difficult as the results show. There can be two reasons for the agent to not show any success: Either it is just physically impossible or %TODO try to get a successful toss by hand -> probably impossible -> try training v4, less weight
